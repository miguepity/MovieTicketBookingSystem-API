...
import { CancelacionesResponseDto } from './dto/cancelaciones-response.dto';
...
export class ReportesController {
  ...
  @ApiOkResponse({ type: CancelacionesResponseDto })
  @ApiBadRequestResponse({ description: 'Parámetros de fecha inválidos' })
  cancelaciones(@Query() q: CancelacionesQueryDto): Promise<CancelacionesResponseDto> {
